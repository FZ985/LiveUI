package io.uicomponents.switchpanel.view.content
 ...
 * blog: yummylau.com
 */
class ConstraintContentContainer : ConstraintLayout, IContentContainer {
    @IdRes
    ...
    private fun initView(attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        ...
        autoResetId =
            typedArray.getResourceId(R.styleable.RelativeContentContainer_auto_reset_area, -1)
        autoResetByOnTouch = typedArray.getBoolean(
            R.styleable.RelativeContentContainer_auto_reset_enable,
            autoResetByOnTouch
        )
        typedArray.recycle()
    }
